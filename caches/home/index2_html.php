<html>
	...
	<?php if ($big !== false): ?>
		...
		<div class="forum">
			...
			<a href="/index2.php?jxid=<?=$v['cid'];?>"><?=$v['classname'];?></a>
			</div>
			<!-- 列表 -->
				...
				<table  rules="none">
					<?php if ($forumSmall !== false): ?>
						...
						<?php if ($value['parentid'] == $v['cid']): ?>
							<tr>
								<td width="50px" align="center"><a href="/index2.php?classid=<?=$value['cid'];?>&page=1"><img src="<?=$value['classpic'];?>" width = "40px" height = "40px"/></a></td>
